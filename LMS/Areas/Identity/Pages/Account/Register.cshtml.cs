...
namespace LMS.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        string CreateNewUser( string firstName, string lastName, DateTime DOB, string departmentAbbrev, string role )
        {
            ...
            do
            {
                uid = "u" + ran.Next(0000001, 9999999);
            }
            while (db.Students.Any(s => s.UId == uid) || db.Professors.Any(p => p.UId == uid)|| db.Administrators.Any(a => a.UId == uid));
            ...
            if (role == "Student")
            {
                ...
                {
                    UId = uid, FName = firstName, LName = lastName, Dob = dob, MajorSubject = departmentAbbrev
                };
            ...
            else if (role == "Professor")
            {
                ...
                {
                    UId = uid, FName = firstName, LName = lastName, Dob = dob, DeptSubject = departmentAbbrev
                };
            ...
            else if (role == "Administrator")
            {
                ...
                {
                    UId = uid, FName = firstName, LName = lastName, Dob = dob
                };
